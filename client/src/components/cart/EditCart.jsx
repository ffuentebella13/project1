...
const EditCart = function (props){
    ...
    useEffect(() => {
        (async () => {
            const productResp = await Axios.get(`/api/cart/${id}`);
                        ...
                        <div className="col-lg-4 d-flex align-items-stretch">
                            ...
                            <div className="card cardContainer" >
                                ...
                                <Form className="form-row" onSubmit={handleSubmit}>
                                    ...
                                    <Form.Control type="hidden" name="product_id" onChange={handleInputChange} value={inputs.product_id}/>
                                    ...
                                    <div className="col-md-4 mb-3">
                                        <Form.Group>
                                            <Form.Control  name="quantity" type="number" required min="1" placeholder={inputs.quantity} required className="formWidth" onChange={handleInputChange} value={inputs.quantity}/>
                                        </Form.Group>
                                    </div>
